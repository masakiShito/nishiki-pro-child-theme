<?php
/**
 * インフラカテゴリ用記事テンプレート - ドキュメント風
 * 公式ドキュメントのような構造化されたクリーンなデザイン
 */
...
<div class="single-wrapper single-wrapper--infra">
        ...
        <section class="infra-hero">
            <div class="infra-hero__container">
                <nav class="infra-hero__breadcrumb" aria-label="パンくずリスト">
                    ...
                    <span class="infra-hero__breadcrumb-sep">/</span>
                ...
                <div class="infra-hero__meta">
                    <div class="infra-hero__meta-row">
                        <span class="infra-hero__meta-label">最終更新</span>
                        <time datetime="<?php echo get_the_modified_date('c'); ?>">
                            <?php echo get_the_modified_date('Y年n月j日'); ?>
                        </time>
                    </div>
                    <div class="infra-hero__meta-row">
                        <span class="infra-hero__meta-label">作成日</span>
                        <time datetime="<?php echo get_the_date('c'); ?>">
                            <?php echo get_the_date('Y年n月j日'); ?>
                        </time>
                    </div>
                    <div class="infra-hero__meta-row">
                        <span class="infra-hero__meta-label">読了時間</span>
                ...
                <div class="infra-hero__tags">
                    <?php foreach ($post_tags as $tag) : ?>
                        <a href="<?php echo esc_url(get_tag_link($tag->term_id)); ?>" class="infra-hero__tag"><?php echo esc_html($tag->name); ?></a>
                    <?php endforeach; ?>
                </div>
                <?php endif; ?>
            </div>
            ...
            <aside class="article-sidebar article-sidebar--infra">
                ...
                <div class="toc-widget toc-widget--infra" id="tocWidget">
                    <div class="toc-widget__header toc-widget__header--infra">
                        <div class="toc-widget__title-wrap">
                            ...
                            <span class="toc-widget__title">このページの内容</span>
                        </div>
                ...
                <?php if ($related_posts && $related_posts->have_posts()) : ?>
                    <section class="article-sidebar__section">
                        <h2 class="article-sidebar__title">関連ドキュメント</h2>
                ...
                <footer class="infra-article-footer">
                    <div class="infra-article-footer__author">
                        ...
                        <div class="infra-article-footer__author-info">
                            <span class="infra-article-footer__author-label">執筆者</span>
    ...
    ?>
    <nav class="post-navigation post-navigation--infra">
        <div class="post-navigation__container">
            <?php if ($prev_post) : ?>
                <a href="<?php echo get_permalink($prev_post); ?>" class="post-navigation__item post-navigation__item--prev">
                    ...
                    <span class="post-navigation__info">
                        <span class="post-navigation__direction">前のドキュメント</span>
            ...
            <?php if ($next_post) : ?>
                <a href="<?php echo get_permalink($next_post); ?>" class="post-navigation__item post-navigation__item--next">
                    ...
                    <span class="post-navigation__info">
                        <span class="post-navigation__direction">次のドキュメント</span>
    ...
    <div class="sns-float" id="snsFloat" role="complementary" aria-label="SNSでシェア">
        <a href="https://twitter.com/intent/tweet?url=<?php echo urlencode(get_permalink()); ?>&text=<?php echo urlencode(get_the_title()); ?>"
           target="_blank" rel="noopener noreferrer" class="sns-float__btn sns-float__btn--x" aria-label="Xでシェア">
        ...
        <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode(get_permalink()); ?>"
           target="_blank" rel="noopener noreferrer" class="sns-float__btn sns-float__btn--facebook" aria-label="Facebookでシェア">
        ...
        <a href="https://line.me/R/msg/text/?<?php echo urlencode(get_the_title() . ' ' . get_permalink()); ?>"
           target="_blank" rel="noopener noreferrer" class="sns-float__btn sns-float__btn--line" aria-label="LINEでシェア">
